 ...
 *
 * The frame is never parsed. ACP carries its own ids, ordering, and cancellation, so anything
 * this plugin decided about a payload would only be a second, weaker copy of what the two ACP
