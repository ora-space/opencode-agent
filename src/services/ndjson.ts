 ...
 *
 * ACP runs over the OpenCode CLI's stdio as one JSON object per line; this codec is the only
...
/** Encodes one ACP NDJSON line for the OpenCode CLI's stdin pipe. */
